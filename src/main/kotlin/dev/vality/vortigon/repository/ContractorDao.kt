...
class ContractorDao(postgresDatasource: DataSource) : AbstractGenericDao(postgresDatasource) {
    ...
    private val rowMapper = RecordRowMapper(CONTRACTOR, dev.vality.vortigon.domain.db.tables.pojos.Contractor::class.java)

    fun findByPartyIdAndContractorId(partyId: String, contractorId: String): dev.vality.vortigon.domain.db.tables.pojos.Contractor? {
    ...
    fun save(contractor: dev.vality.vortigon.domain.db.tables.pojos.Contractor) {
